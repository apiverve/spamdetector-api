...
class spamdetectorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/spamdetector');
        }
        ...
        this.validationRules = {"text":{"type":"string","required":true},"email":{"type":"string","required":false,"format":"email"},"ip":{"type":"string","required":false,"format":"ip"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/spamdetector`);
        }
    }
...
module.exports = spamdetectorWrapper;
