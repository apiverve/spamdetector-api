...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/spamdetector',
        'Source': 'https://github.com/apiverve/spamdetector-api',
        'Bug Tracker': 'https://github.com/apiverve/spamdetector-api/issues'
    },
    classifiers=[
