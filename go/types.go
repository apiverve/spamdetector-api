// Package spamdetector provides a Go client for the Spam Detector API.
//
// For more information, visit: https://apiverve.com/marketplace/spamdetector?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Spam Detector API.
//
// Parameters:
//   - text (required): string - The text to detect spam in
//   - email: string - The email address to validate against the spam database. This is optional [format: email]
//   - ip: string - The IP address to validate against the spam database.  This is optional [format: ip]
type Request struct {
...
// ResponseData contains the data returned by the Spam Detector API.
type ResponseData struct {
	LikelySpam bool `json:"likelySpam"`
	IsDisposableEmail bool `json:"isDisposableEmail"`
	IsIPBlacklisted bool `json:"isIPBlacklisted"`
	IpDetails IpDetailsData `json:"ipDetails"`
	Parsed bool `json:"parsed"`
}

// IpDetailsData represents the ipDetails object.
type IpDetailsData struct {
