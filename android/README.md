...
```gradle
dependencies {
    implementation 'com.github.apiverve:spamdetector-api:1.1.12'
}
```
...
```java
import com.apiverve.spamdetector.SpamDetectorAPIClient;
import com.apiverve.spamdetector.APIResponse;
import com.apiverve.spamdetector.APIException;

// Initialize the client
SpamDetectorAPIClient client = new SpamDetectorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/spamdetector](https://docs.apiverve.com/ref/spamdetector)
...
- **Documentation:** [https://docs.apiverve.com/ref/spamdetector](https://docs.apiverve.com/ref/spamdetector)
- **Issues:** [GitHub Issues](https://github.com/apiverve/spamdetector-api/issues)
