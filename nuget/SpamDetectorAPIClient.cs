...
namespace APIVerve.API.SpamDetector
{
    ...
    /// <summary>
    /// Client for the SpamDetector API
    /// </summary>
    public class SpamDetectorAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/spamdetector";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "email", new ValidationRule { Type = "string", Required = false, Format = "email" } },
            { "ip", new ValidationRule { Type = "string", Required = false, Format = "ip" } }
        };
        ...
        public SpamDetectorAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SpamDetectorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SpamDetectorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, SpamDetectorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(SpamDetectorQueryOptions options)
        {
        ...
        public ResponseObj Execute(SpamDetectorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(SpamDetectorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(SpamDetectorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(SpamDetectorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(SpamDetectorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(SpamDetectorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(SpamDetectorQueryOptions options)
        {
